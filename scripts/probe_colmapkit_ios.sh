...
- Apple framework version/build: $COLMAPKIT_FRAMEWORK_VERSION/$COLMAPKIT_FRAMEWORK_BUILD_VERSION
...
run_slice() {
  ...
  local configure_args=(
    ...
    -DCOLMAPKIT_FRAMEWORK_VERSION="$COLMAPKIT_FRAMEWORK_VERSION"
    -DCOLMAPKIT_FRAMEWORK_BUILD_VERSION="$COLMAPKIT_FRAMEWORK_BUILD_VERSION"
    -DGUI_ENABLED=OFF
    -DCUDA_ENABLED=OFF
    -DOPENGL_ENABLED=OFF
    -DMVS_ENABLED=OFF
