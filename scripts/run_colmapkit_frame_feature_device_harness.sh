...
EXPECTED_FRAMEWORK_SHA256="${COLMAPKIT_DEVICE_EXPECTED_FRAMEWORK_SHA256:-1c34a7cc27a35c0004c6846dcfdc7c632c1fae60fe77a5ec6b95a72b089695d7}"
EXPECTED_ZIP_SHA256="${COLMAPKIT_DEVICE_EXPECTED_ZIP_SHA256:-fe7c88966b0f4f3e67d003a0d0160d40a716590db769a465f732ffbc31d48531}"
EXPECTED_MATRIX_SHA256="${COLMAPKIT_DEVICE_EXPECTED_MATRIX_SHA256:-758bed5ae71ea8968a6e4e88c74869459826356633fbba86ebe77d1e62842f92}"
EXPECTED_RELEASE="${COLMAPKIT_DEVICE_EXPECTED_RELEASE:-0.3.0-rc.3+14eadc5c}"
EXPECTED_ENGINE_COMMIT="${COLMAPKIT_DEVICE_EXPECTED_ENGINE_COMMIT:-14eadc5c}"
...
cmake \
  ...
  -DCOLMAPKIT_EXPECTED_RELEASE="$EXPECTED_RELEASE" \
  -DCOLMAPKIT_EXPECTED_ENGINE_COMMIT="$EXPECTED_ENGINE_COMMIT" \
