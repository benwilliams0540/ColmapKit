...
if(METAL_ENABLED)
    if(IS_MACOS)
        ...
        if(METAL_FRAMEWORK AND FOUNDATION_FRAMEWORK)
            ...
            list(APPEND COLMAP_METAL_LIBRARIES
                 ${METAL_FRAMEWORK}
                 ${FOUNDATION_FRAMEWORK})
            message(STATUS "Enabling Metal support")
        else()
            set(METAL_ENABLED OFF)
            message(STATUS "Disabling Metal support (not found)")
        endif()
    else()
        set(METAL_ENABLED OFF)
        message(STATUS "Disabling Metal support (Apple platforms only)")
    endif()
else()
...
if(SIFT_METAL_ENABLED)
    if(METAL_ENABLED)
        list(APPEND COLMAP_COMPILE_DEFINITIONS COLMAP_SIFT_METAL_ENABLED)
        message(STATUS "Enabling SiftMetal extraction support")
    else()
        set(SIFT_METAL_ENABLED OFF)
        message(STATUS "Disabling SiftMetal extraction support (Metal not found)")
    endif()
else()
    message(STATUS "Disabling SiftMetal extraction support")
endif()
